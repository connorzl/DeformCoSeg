...
def get_graph_feature(x, k=50, idx=None):
    batch_size = x.size(0)
    num_points = x.size(2)
...
class DGCNN(nn.Module):
    def __init__(self, input_features, output_features):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(2*input_features, 64, kernel_size=1, bias=False),
        ...
        self.conv8 = nn.Sequential(nn.Conv1d(512, 256, kernel_size=1, bias=False),
                                   nn.LeakyReLU(negative_slope=0.2))
        self.conv9 = nn.Conv1d(256, output_features, kernel_size=1, bias=False)
    ...
    def forward(self, x):
        ...
        x = self.conv9(x)                       # (batch_size, 256, num_points) -> (batch_size, output_features, num_points)
        x = x.permute(0, 2, 1)
        return x

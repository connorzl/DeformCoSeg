...
feature_correlator = ckpt["feature_correlator"].to(device)
feature_correlator.eval()
...
for batch_idx, data_tensors in enumerate(train_loader):    
    ...
    for k in range(batchsize):
        ...
        # Deform.
        part_0 = deformer_0.forward(GV_src_device, src_correlated_flow_features)
        part_1 = deformer_1.forward(GV_src_device, src_correlated_flow_features)
